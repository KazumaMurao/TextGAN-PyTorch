...
# ===Oracle  or Real===
if_real_data = [int(False), int(True), int(True), int(True), int(True), int(True)]
dataset = ['oracle', 'image_coco', 'emnlp_news', 'chord', 'aozora_wakati', 'musicautobot']
vocab_size = [5000, 0, 0, 0, 0, 0]
